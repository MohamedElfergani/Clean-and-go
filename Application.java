...
public class Application {
    ...
    public static void analyze_business(Connection conn) throws SQLException, IOException{ 
        boolean done = false;
        BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
    ...
    /*--------------------------------------------SECOND SCENARIO---------------------------------------------------- */
    /*--------------------------------------------NUMBER ONE--------------------------------------------------------- */
    private static void new_customers(Connection conn) throws SQLException, IOException{ 
        if(conn == null){
            System.out.println("server issue");
        }
        Statement stmt = conn.createStatement();
